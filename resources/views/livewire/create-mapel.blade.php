        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form action="">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div>
                        <h1 class="font-bold text-center mb-4">CREATE MATA PELAJARAN</h1>
                    </div>
                    <div>
                        <div class="mb-2">
                            <input wire:model="mapelId" type="hidden" class="shadow appearence-none rounded w-full px-3 py-2 text-blue-900" placeholder="Input Mata Pelajaran">
                        </div>
                        <div class="mb-2">
                            <label for="namaMapel" class="block">Mata Pelajaran</label>
                            <input wire:model="namaMapel" type="text" class="shadow appearence-none rounded w-full px-3 py-2 text-blue-900" placeholder="Input Mata Pelajaran">
                            @error('namaMapel') <h1 class="text-red-500">{{$message}}</h1> @enderror
                        </div>
                    </div>
                </div>
