...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, rgba(179, 28, 132, 1) 0%, rgba(226, 18, 236, 1) 61%, rgba(63, 94, 251, 1) 100%);
        }
    </style>
</head>
        ...
        <div class="container mx-auto px-8">
            <div class="w-full flex flex-col md:flex-row py-6">
                ...
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Official Website</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
